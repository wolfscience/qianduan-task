 ...
 */
var level;  // 开始扫描角度，正北为0 ，顺时针，0-360
//传入图层名称
function Sector(canvas) {
    ...
    this.argIfRadius = [0, 0, 0, 1, 1, 0]; //参数是否是角度
...
Sector.prototype = {
    ...
    setup: function() {
        ...
        for (var i = -1, l = data.length; ++i < l;) {
            ...
            for (var r, pd = this.pointDistance, t = pd; t <= 1; t += pd) {
                ...
                args[0] = t;
                r = this.pathMethods.apply(null,args);
                this.points.push({
                    x: r[0],
                    y: r[1],
                    progress: t
    ...
    //计算外部点集
    pathMethods: function(t, cx, cy, radius, start, end) {
